...
Namespace NScript
    ...
    Friend Module SafeNativeMethods
        ...
        Friend Structure KeyboardHookStruct
            ...
            Dim DwExtraInfo As Integer
        End Structure
        Public Declare Function GetWindowRect Lib "user32.dll" (ByVal hwnd As IntPtr, ByRef lpRect As Rectangle) As <MarshalAs(UnmanagedType.I4)> Boolean
        Friend Declare Function GetWindowThreadProcessId Lib "user32" (hwnd As IntPtr, ByRef ProcessId As Long) As Long
        Friend Delegate Function HookProc(ByVal nCode As Integer, ByVal wParam As Integer, ByRef lParam As MouseLLHookStruct) As Integer
